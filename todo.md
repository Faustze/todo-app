...
- [ ] При обновлении страницы теряется используемая цветовая тема из стора

## Итерация 7 — Типографика

- [x] Выбрать шрифт и подобрать его размеры адаптивно
- [x] Разобраться с типографией (tokens/typography.ts создан, но не привязан)
